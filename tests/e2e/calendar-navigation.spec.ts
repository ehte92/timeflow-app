...
test.describe("Calendar Navigation - Comprehensive Tests", () => {
  ...
  test.describe("2. Month View Year Boundary Navigation", () => {
    test("should navigate from January to December of previous year", async ({
      page,
    }) => {
    ...
    test("should navigate from December to January of next year", async ({
      page,
    }) => {
  ...
  test.describe("3. Month View Rapid Navigation", () => {
    test("should handle rapid Previous clicks without errors", async ({
      page,
    }) => {
  ...
  test.describe("4. Week View Navigation", () => {
    ...
    test("should handle week navigation across month boundaries", async ({
      page,
    }) => {
      // Switch to Week view
      await page.getByRole("combobox").click();
  ...
  test.describe("5. Day View Navigation", () => {
    ...
    test("should handle day navigation across month boundaries", async ({
      page,
    }) => {
      // Switch to Day view
      await page.getByRole("combobox").click();
  ...
  test.describe("6. Cross-View Navigation", () => {
    test("should preserve date when switching between views", async ({
      page,
    }) => {
  ...
  test.describe("7. Today Button Across Views", () => {
    test("should return to current date in Month view from far future", async ({
      page,
    }) => {
    ...
    test("should return to current date in Week view from far past", async ({
      page,
    }) => {
      // Switch to Week view
      await page.getByRole("combobox").click();
  ...
  test.describe("8. Console Error Monitoring", () => {
    test("should have zero console errors during navigation", async ({
      page,
    }) => {
      const consoleErrors: string[] = [];
  ...
  test.describe("10. Visual Verification", () => {
    test("should display correct month grid in Month view", async ({
      page,
    }) => {
      // Verify Month view shows calendar grid
      const monthGridDays = await page
        .locator('[aria-label*="October"]')
        .count();
